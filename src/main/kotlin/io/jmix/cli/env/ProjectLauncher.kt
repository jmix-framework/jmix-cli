...
object ProjectLauncher {
    ...
    fun openCommand(
        ...
        ideaCommand(projectDir, os, pathEnv, macAppDirs)?.let { return OpenCommand(Opener.IDEA, it) }
        return OpenCommand(Opener.FILE_MANAGER, fileManagerCommand(projectDir, os))
    }
    ...
    fun open(open: OpenCommand, onWarning: (String) -> Unit) {
        try {
